...
slides=_site/training-material/topics/galaxy-project/slides/introduction.pdf #$1  # e.g. _site/training-material/topic/admin/tutorials/ansible/slides.pdf
source="topics/galaxy-project/slides/introduction.html" # $2  # e.g. topic/admin/tutorials/ansible/slides.html
output=_site/training-material/topics/galaxy-project/slides/introduction.mp4 # $3  # e.g. _site/training-material/topic/admin/tutorials/ansible/slides.mp4
